...
namespace LB_3
{
    public partial class FormMain : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // Метод Load расширения используется для загрузки всех пользователей из бд в BlogContext бд
            this.db.Users.Load();
        ...
        {
            //Вызывает SaveChanges, который сохраняет все изменения, внесенные в бд
            this.db!.SaveChanges();
